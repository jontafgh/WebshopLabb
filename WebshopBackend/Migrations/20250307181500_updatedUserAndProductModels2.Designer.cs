...
namespace WebshopBackend.Migrations
{
    ...
    [Migration("20250307181500_updatedUserAndProductModels2")]
    partial class updatedUserAndProductModels2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebshopBackend.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebshopBackend.WebshopUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebshopBackend.WebshopUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebshopBackend.WebshopUser", b =>
                {
                    b.HasOne("WebshopBackend.Address", "Address")
                        .WithMany("Users")
